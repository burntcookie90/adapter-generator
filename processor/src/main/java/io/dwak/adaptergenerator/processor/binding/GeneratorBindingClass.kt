  ...
  fun generate(): TypeSpec {
    ...
    val onClickAnonymous = TypeSpec.anonymousClassBuilder("")
        ...
        .addMethod(MethodSpec.methodBuilder("onClick")
            ...
            .addStatement("listener.onViewHolderClick(holder)")
            .endControlFlow()
            .build())
        .build()
    ...
    val getItemMethod = MethodSpec.methodBuilder("get")
        .addModifiers(Modifier.PUBLIC)
    ...
    val interactionListener = TypeSpec.interfaceBuilder("ViewHolderClickListener")
        .addMethod(MethodSpec.methodBuilder("onViewHolderClick")
            .addModifiers(Modifier.ABSTRACT, Modifier.PUBLIC)
            .addParameter(ParameterSpec.builder(viewHolder, "viewHolder").build())
            .build())
        .build()


    val itemClickName = ClassName.get("$classPackage.$className", "ViewHolderClickListener")
    val setOnClickMethod = MethodSpec.methodBuilder("setOnViewHolderClickListener")
        .addModifiers(Modifier.PUBLIC)
